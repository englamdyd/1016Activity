...
public class MainActivity extends AppCompatActivity {
    //여기에 변수를 선언하며 클래스 내의 모든 곳에서 변수를 사용 할 수 있다.
    Button contact;
    Button camera;
    Button voice;
    Button map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //여기다가 변수를 만들면 final을 붙이지 않는 이상 다른 객체나 메소드 안에서 사용이 안된다.
    ...
    //startActivityForResult로 인텐트를 실행한 후 인텐트의 액티비티가 종료되었을 때 호출되는 메소드
